...
`;for(let O of A)o+=`<span class="wc__row__letter">${O}</span> 
`;o+=`</div> 
`}o+=`</div> 
`,o+=`    </div> 
`,o+=`    <div class="wc__column__right"> 
