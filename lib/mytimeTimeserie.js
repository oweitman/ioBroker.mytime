...
class mytimeTimeserie {
    ...
    doObserverServerTimeseries() {
        ...
        this.ioUtil.setAdapterTimeout('doObserverServerTimeseries', this.doObserverServerTimeseries.bind(this), 5000);
    }
    /**
    ...
    doTimeoutActivate(ts) {
        ...
        this.ioUtil.setAdapterTimeout(ts.timerid, this.doTimeoutDeactivate.bind(this), ts.duration * 1000, ts);
    }
    /**
