...
import TSSettingsRruleDateList from "./settingsruledatelist";
...
class TSSettingsAddRrule extends React.Component {
...
export default withStyles(styles)(TSSettingsAddRrule);