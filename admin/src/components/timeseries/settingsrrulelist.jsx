...
class TSSettingsRruleList extends React.Component {
                    ...
                    <Table size="small">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell classes={{root:classes.tabletype}}><b>{I18n.t("Type")}</b></TableCell>
...
export default withStyles(styles)(TSSettingsRruleList);